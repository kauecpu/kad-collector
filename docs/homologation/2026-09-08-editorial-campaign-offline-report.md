...
- Inventário: `data/editorial-campaign/pf-bb-corepi-offline/review/index.json`
- Hash: `5ea21761ecf16a1c6620ac19ed5ab9637d166433e13e636eb89b53f43305a328`
...
| Em quarentena | 422 |
| Classificadas por regra | 468 |
| Sugeridas pelo Qwen | 0 |
| Taxonomia não resolvida | 5112 |
| Decisões humanas | 0 |
...
| 2 | 70 |
| 4 | 70 |
| Estatística Descritiva | 51 |
| Segurança da Informação | 48 |
| Investigação Criminal | 34 |
| Contabilidade Geral | 25 |
| Gestão de Pessoas | 25 |
| Infraestrutura de TI | 23 |
| Seguridade Social | 22 |
| Ciência de Dados | 19 |
| Interpretação de Textos | 16 |
...
| Gestão Organizacional | 8 |
| Lógica Proposicional | 8 |
| Licitações e Contratos | 7 |
| Direitos Fundamentais | 6 |
| Macroeconomia | 4 |
| Obrigação Tributária | 4 |
| Sistema Tributário Nacional | 2 |
| Obrigações Acessórias | 1 |
...
| Bloco II | 252 |
| Bloco III | 216 |
| Modelagem e Consulta de Dados | 50 |
| Gestão da Segurança da Informação | 47 |
| Medidas de Tendência Central | 28 |
| Liderança e Motivação | 25 |
| Inquérito Policial | 21 |
| Regime Geral de Previdência Social | 20 |
| Orçamento Público | 15 |
| Regência e Crase | 15 |
| Local de Crime | 14 |
| Elementos e Atributos do Ato Administrativo | 13 |
...
- 5112 questões não receberam classificação completa na taxonomia atual.
