...
class CollectorSettings(StrictModel):
    ...
    max_archive_bytes: int = Field(default=100_000_000, ge=1_024)
    max_archive_members: int = Field(default=250, ge=1, le=2_000)
    max_archive_uncompressed_bytes: int = Field(default=250_000_000, ge=1_024)
