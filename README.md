...
chamadas simultâneas podem saturar a VRAM e piorar o tempo total. O gate de GPU é repetido antes
de cada bloco e durante as chamadas de acordo com o intervalo configurado. Pausar durante um bloco confirma
